...
fn main() {
    ...
    match    input_inside(1..=5) {
        ...
        2 => println!("A friend of Andrew the guard laughed, Andrew has no friends. the gaurd picked you up and beat you, then hand cuffed you and sent you to be exacuted.\n GAME OVER."), 
